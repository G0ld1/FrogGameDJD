...
public class GrapplingHook : MonoBehaviour
{
    ...
    void Update()
    {
        // Use InputManager action when available, fallback to key for compatibility
        bool startGrapple = InputManager.grappleWasPressed || Input.GetKeyDown(grappleKey);
        ...
        if (isTargeting)
        {
            ...
            // existing targeting behaviour (if you expand targeting later)
        }
    }
